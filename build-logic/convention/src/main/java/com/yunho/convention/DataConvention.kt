    ...
    override fun apply(target: Project) {
        with(target) {
            ...
            dependencies {
                ...
                implementation(find(Dependency.RETROFIT_CORE))
                implementation(find(Dependency.RETROFIT_CONVERTER_GSON))
                implementation(find(Dependency.RETROFIT_KOTLIN_SERIALIZATION))
                implementation(find(Dependency.GSON))

                implementation(find(Dependency.ANDROIDX_DATASTORE_CORE))
                implementation(find(Dependency.ANDROIDX_DATASTORE_PREFERENCES_CORE))
